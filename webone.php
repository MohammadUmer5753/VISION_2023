...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/web-one.css">
...
<?php include 'header.php'; ?>
	...
	<!----home section design---->
	<section class="home" id="home" style="background-color:#020312 !important;">
		<div class="home-text">
			<h4>Website Designing</h4>
			<h1> we develop full-stack website with the love of a UI/UX designing.</h1>
			<a href="#services" class="btn">Explore now</a>
		</div>

		<div class="home-img">
			 <!-- <img src="Images/web-main2.jpg">  -->
		</div>
	</section>
...
<section id="service" class="service">
	...
	<div class="row-section">
	  ...
	  <div class="image">
		<img src="web photos/Website setup-amico.png" alt="">
	  </div>
	  <div class="content">
	...
	<div class="row-section">
	  ...
	  <div class="image">
		<img src="web photos/Website setup-bro.png" alt="">
	  </div>
	...
	<div class="row-section">
	  ...
	  <div class="image">
		<img src="web photos/Website setup-cuate (1).png" alt="">
	  </div>
	  <div class="content">
	...
	<div class="row-section">
	  ...
	  <div class="image">
		<img src="web photos/Website setup-rafiki.png" alt="">
	  </div>
	...
	<div class="row-section">
	  ...
	  <div class="image">
		<img src="web photos/Code typing-rafiki.png" alt="">
	  </div>
	  <div class="content">
		<h3>seo freindly</h3>
		<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde voluptatem, tempore hic deserunt vel temporibus aperiam recusandae ratione, obcaecati at qui accusamus enim, laudantium eveniet. Inventore voluptas nemo placeat. Voluptas.</p>
		...
		<div class="feature-content">
			<div class="row">
				<div class="main-row">
					<div class="row-text">
						<h6>Promises</h6>
						<h3>mobile<br> freindly</h3>
						<a href="#" class="row-btn">Show me all</a>
					</div>
					<div class="row-img">
						<img src="images/web-one.webp">
					</div>
				</div>
			</div>
			...
			<div class="row row2">
				<div class="main-row">
					<div class="row-text">
						<h6>Promises</h6>
						<h3>seo <br> freindly</h3>
						<a href="#" class="row-btn">Show me all</a>
					</div>
					<div class="row-img">
						<img src="Images/web-two.png">
					</div>
				</div>
			</div>
	...
	<section class="product">
		...
		<div class="product-content">
			...
			<div class="box">
				<div class="box-img">
					<img src="Images/web-five.jpg">
				</div>
				<h3>Infographic website</h3>
				<h4>New Design 2022</h4>
				<div class="inbox">
					<div>
						<a href="#" class="price">$42.00</a>
